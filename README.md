...
* [Principales anotaciones](#principales-anotaciones)
  ...
  * [La anotaciones @Controller, @Service y @Repository](#la-anotaciones-controller-service-y-repository)
  * [La anotaciones @SpringBootApplication](#la-anotaciones-springbootapplication)
  * [La anotaciones RestControllerAdvicer](#la-anotaciones-restcontrolleradvicer)
  * [Definición de filtros e interceptores](#definición-de-filtros-e-interceptores)
    * [Definición de filtros](#definición-de-filtros)
    * [Definición de Interceptores](#definición-de-interceptores)
